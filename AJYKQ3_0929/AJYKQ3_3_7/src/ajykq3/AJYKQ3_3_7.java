...
public class AJYKQ3_3_7 implements Serializable {
	...
	public AJYKQ3_3_7(String r, String t, int a) {
		this.rsz = r;
		this.tipus = t;
		this.ar = a;
	}
	...
	public static void hf4() {
		AJYKQ3_3_7[] autoim = { new AJYKQ3_3_7("R11", "Opel", 333), new AJYKQ3_3_7("R12", "Fiat", 233),
				new AJYKQ3_3_7("R14", "Skoda", 364) };
		try {
			ObjectOutputStream kifile = new ObjectOutputStream(new FileOutputStream("Autok.dat"));
			for (AJYKQ3_3_7 auto : autoim) {
	...
	public static void hf5() {
		...
		try {
			...
			if (fn.exists()) {
				...
				try {
					while (true) {
						ma = (AJYKQ3_3_7) kifile.readObject();
						if (ma.ar > 300) {
